...
function UpdateAddress() {
    ...
    //Create the parameter string
    var newaddress = '{"OrderID":"' + ordernumber +  '","ShippingAddress":"' + shippingaddress + '","ShippingName":"' + shippingname + 
                        '","ShippingCity":"' + shippingcity + '","ShippingPostCode":"' + shippingpostcode + '"}';
